...
<div class="min-h-screen bg-zinc-950 text-zinc-50 flex items-center justify-center p-4">
  ...
  <div
    class="absolute inset-0 bg-[radial-gradient(#27272a_1px,transparent_1px)] bg-size-[16px_16px] mask-[radial-gradient(ellipse_80%_50%_at_50%_0%,#000_80%,transparent_100%)]"
  ></div>
  ...
  <div class="relative w-full max-w-sm space-y-6">
    ...
    <div class="text-center space-y-2">
      <div
        class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-zinc-800 border border-zinc-700 mb-4"
      >
        <svg
    ...
    <!-- Footer -->
    <p class="text-center text-xs text-zinc-600">Protected access</p>
  </div>
</div>
