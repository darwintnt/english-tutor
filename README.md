...
3. Speak about any topic
4. Tap the **stop button** to send
5. The AI responds and asks follow-up questions
6. If you make a mistake, you'll get a correction in Spanish at the end
7. Adjust speech speed with the slider at the bottom
8. Say "goodbye" or tap **End** when done
